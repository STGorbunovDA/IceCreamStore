...
namespace IceCreamStore.API.Data
{
    public class DataContext : DbContext
    {
        ...
        {
            Icecream[] icecreams = [
                new Icecream { Id = 1, Name = "Vanilla Delight", Image = "https://raw.githubusercontent.com/STGorbunovDA/IceCreamStore/dev/content/img/ic_0.jpg", Price = 6.25 },
                new Icecream { Id = 2, Name = "ChocoBerry Bliss", Image = "https://raw.githubusercontent.com/STGorbunovDA/IceCreamStore/dev/content/img/ic_1.jpg", Price = 7.5 },
                new Icecream { Id = 3, Name = "Minty Cookie Crunch", Image = "https://raw.githubusercontent.com/STGorbunovDA/IceCreamStore/dev/content/img/ic_2.jpg", Price = 8.75 },
                new Icecream { Id = 4, Name = "Strawberry Dream", Image = "https://raw.githubusercontent.com/STGorbunovDA/IceCreamStore/dev/content/img/ic_3.jpg", Price = 6.95 },
                new Icecream { Id = 5, Name = "Cookie Dough Extravaganza", Image = "https://raw.githubusercontent.com/STGorbunovDA/IceCreamStore/dev/content/img/ic_4.jpg", Price = 9.2 },
                new Icecream { Id = 6, Name = "Caramel Swirl Symphony", Image = "https://raw.githubusercontent.com/STGorbunovDA/IceCreamStore/dev/content/img/ic_5.jpg", Price = 7.75 },
                new Icecream { Id = 7, Name = "Peanut Butter Paradise", Image = "https://raw.githubusercontent.com/STGorbunovDA/IceCreamStore/dev/content/img/ic_6.jpg", Price = 8.5 },
                new Icecream { Id = 8, Name = "Mango Tango Tango", Image = "https://raw.githubusercontent.com/STGorbunovDA/IceCreamStore/dev/content/img/ic_7.jpg", Price = 9.8 },
                new Icecream { Id = 9, Name = "Hazelnut Heaven", Image = "https://raw.githubusercontent.com/STGorbunovDA/IceCreamStore/dev/content/img/ic_8.jpg", Price = 8.95 },
                new Icecream { Id = 10, Name = "Blueberry Bliss Bonanza", Image = "https://raw.githubusercontent.com/STGorbunovDA/IceCreamStore/dev/content/img/ic_9.jpg", Price = 7.2 },
                new Icecream { Id = 11, Name = "Toffee Twist Temptation", Image = "https://raw.githubusercontent.com/STGorbunovDA/IceCreamStore/dev/content/img/ic_10.jpg", Price = 7.95 },
                new Icecream { Id = 12, Name = "Rocky Road Revelry", Image = "https://raw.githubusercontent.com/STGorbunovDA/IceCreamStore/dev/content/img/ic_11.jpg", Price = 9.5 },
                new Icecream { Id = 13, Name = "Passionfruit Paradise", Image = "https://raw.githubusercontent.com/STGorbunovDA/IceCreamStore/dev/content/img/ic_12.jpg", Price = 8.75 },
                new Icecream { Id = 14, Name = "Cotton Candy Carnival", Image = "https://raw.githubusercontent.com/STGorbunovDA/IceCreamStore/dev/content/img/ic_13.jpg", Price = 7.2 },
                new Icecream { Id = 15, Name = "Lemon Sorbet Serenity", Image = "https://raw.githubusercontent.com/STGorbunovDA/IceCreamStore/dev/content/img/ic_14.jpg", Price = 6.9 },
                new Icecream { Id = 16, Name = "Maple Pecan Pleasure", Image = "https://raw.githubusercontent.com/STGorbunovDA/IceCreamStore/dev/content/img/ic_15.jpg", Price = 8.25 },
                new Icecream { Id = 17, Name = "Raspberry Ripple Rhapsody", Image = "https://raw.githubusercontent.com/STGorbunovDA/IceCreamStore/dev/content/img/ic_16.jpg", Price = 7.45 },
                new Icecream { Id = 18, Name = "Almond Joyful Jubilee", Image = "https://raw.githubusercontent.com/STGorbunovDA/IceCreamStore/dev/content/img/ic_17.jpg", Price = 9.95 },
                new Icecream { Id = 19, Name = "Blue Lagoon Bliss", Image = "https://raw.githubusercontent.com/STGorbunovDA/IceCreamStore/dev/content/img/ic_18.jpg", Price = 8.5 },
                new Icecream { Id = 20, Name = "Coconut Caramel Carnival", Image = "https://raw.githubusercontent.com/STGorbunovDA/IceCreamStore/dev/content/img/ic_19.jpg", Price = 7.8 } ];
